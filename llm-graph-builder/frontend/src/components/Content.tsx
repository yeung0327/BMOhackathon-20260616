    ...
    setMessages([
      {
        ...
        modes: {
          'graph+vector+fulltext': {
            message:
              ' Welcome to the Roots & Shoots Knowledge Graph Chat. You can ask questions related to documents which have been completely processed.',
          },
        },
        user: 'chatbot',
    ...
    <>
      ...
      <div className={`n-bg-palette-neutral-bg-default main-content-wrapper`}>
        <Flex
          ...
          flexWrap='wrap'
        >
          <div className='connectionstatus__container' style={{ display: 'none' }}>
